...
export class AddInvitesTable1713203005975 implements MigrationInterface {
    name = 'AddInvitesTable1713203005975'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`invite\` (\`id\` int NOT NULL AUTO_INCREMENT, \`invitee_email\` varchar(255) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`acceptedAt\` datetime NOT NULL, \`revokedAt\` datetime NOT NULL, \`senderId\` int NULL, \`workspaceId\` int NULL, \`statusId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
